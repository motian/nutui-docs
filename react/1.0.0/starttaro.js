...
</code></pre><h3>\u6309\u7167\u4E0B\u65B9\u56FE\u7247\u4F9D\u6B21\u9009\u62E9\uFF0C\u9009\u62E9 Vue3 + NutUI \u6A21\u677F</h3><img src="https://storage.360buyimg.com/jdc-article/taro.jpg"><blockquote><p>\u6CE8\u610F\uFF1A\u5982\u679C\u975E\u6A21\u677F\u65B9\u5F0F\uFF0C\u5355\u72EC\u5B89\u88C5\u7684 nutui-taro npm \u5305\uFF0C\u9700\u8981\u6309\u4EE5\u4E0B\u6B65\u9AA4\u8FDB\u884C\u914D\u7F6E</p></blockquote><h3>\u914D\u7F6E taro \u63D2\u4EF6 @tarojs/plugin-html</h3><ol><li>\u9996\u5148\u4E0B\u8F7D <a href="https://taro-docs.jd.com/taro/docs/use-h5/">@tarojs/plugin-html</a></li></ol><pre><code class="language-bash">yarn add @tarojs/plugin-html
</code></pre><ol start="2"><li>\u5728\u9879\u76EE\u4E2D\u914D\u7F6E</li></ol><pre><code class="language-javascript"><span class="hljs-comment">// config/index.js</span>
config = {
  <span class="hljs-comment">// ...</span>
  <span class="hljs-attr">plugins</span>: [<span class="hljs-string">&#39;@tarojs/plugin-html&#39;</span>]
}
</code></pre><ol start="3"><li>\u914D\u7F6E nutui 375\u5C3A\u5BF8</li></ol><pre><code class="language-javascript"><span class="hljs-comment">// config/index.js</span>
config = {
  <span class="hljs-comment">// ...</span>
...
</code></pre><h3>NPM \u4F7F\u7528\u793A\u4F8B</h3><blockquote><p>\u6CE8\u610F\uFF1A\u8FD9\u79CD\u65B9\u5F0F\u5C06\u4F1A\u5BFC\u5165\u6240\u6709\u7EC4\u4EF6\uFF0C\u6253\u5305\u6587\u4EF6\u5927\u5C0F\u4F1A\u5F88\u5927</p></blockquote><pre><code class="language-javascript"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;vue&quot;</span>;
...
</code></pre>`,46),e=[t],i={setup(c,{expose:s}){return s({frontmatter:{}}),(r,u)=>(n(),a("div",l,e))}};export{i as default};
