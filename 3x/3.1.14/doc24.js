...
<span class="hljs-tag">&lt;/<span class="hljs-name">nut-form</span>&gt;</span>
</code></pre><h3>\u52A8\u6001\u8868\u5355</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">nut-form</span> <span class="hljs-attr">:model-value</span>=<span class="hljs-string">&quot;dynamicForm.state&quot;</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;dynamicRefForm&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">nut-form-item</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u59D3\u540D&quot;</span> <span class="hljs-attr">prop</span>=<span class="hljs-string">&quot;name&quot;</span> <span class="hljs-attr">required</span> <span class="hljs-attr">:rules</span>=<span class="hljs-string">&quot;[{ required: true, message: &#39;\u8BF7\u586B\u5199\u59D3\u540D&#39; }]&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;nut-input-text&quot;</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;dynamicForm.state.name&quot;</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;\u8BF7\u8F93\u5165\u59D3\u540D&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;text&quot;</span> /&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">nut-form-item</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">nut-form-item</span> <span class="hljs-attr">:label</span>=<span class="hljs-string">&quot;&#39;\u8054\u7CFB\u65B9\u5F0F&#39;+index&quot;</span> <span class="hljs-attr">:prop</span>=<span class="hljs-string">&quot;&#39;tels.&#39; + index + &#39;.value&#39;&quot;</span> <span class="hljs-attr">required</span>
    <span class="hljs-attr">:rules</span>=<span class="hljs-string">&quot;[{ required: true, message: &#39;\u8BF7\u586B\u5199\u8054\u7CFB\u65B9\u5F0F&#39;+index }]&quot;</span> <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;item.key&quot;</span>
    <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;(item,index) in dynamicForm.state.tels&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;nut-input-text&quot;</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;item.value&quot;</span> <span class="hljs-attr">:placeholder</span>=<span class="hljs-string">&quot;&#39;\u8BF7\u8F93\u5165\u8054\u7CFB\u65B9\u5F0F&#39;+index&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;text&quot;</span> /&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">nut-form-item</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">nut-cell</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">nut-button</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;margin-right: 10px&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;dynamicForm.methods.add&quot;</span>&gt;</span>\u6DFB\u52A0<span class="hljs-tag">&lt;/<span class="hljs-name">nut-button</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">nut-button</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;margin-right: 10px&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;dynamicForm.methods.remove&quot;</span>&gt;</span>\u5220\u9664<span class="hljs-tag">&lt;/<span class="hljs-name">nut-button</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">nut-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;primary&quot;</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;dynamicForm.methods.submit&quot;</span>&gt;</span>\u63D0\u4EA4<span class="hljs-tag">&lt;/<span class="hljs-name">nut-button</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">nut-cell</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">nut-form</span>&gt;</span>
    ...
    <span class="hljs-keyword">const</span> dynamicRefForm = ref&lt;any&gt;(<span class="hljs-literal">null</span>);
    <span class="hljs-keyword">const</span> dynamicForm = {
      <span class="hljs-attr">state</span>: reactive({
        <span class="hljs-attr">name</span>: <span class="hljs-string">&#39;&#39;</span>,
        <span class="hljs-attr">tels</span>: <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>({
      ...
      <span class="hljs-attr">methods</span>: {
        <span class="hljs-function"><span class="hljs-title">submit</span>(<span class="hljs-params"></span>)</span> {
          dynamicRefForm.value.validate().then(<span class="hljs-function">(<span class="hljs-params">{ valid, errors }: any</span>) =&gt;</span> {
            <span class="hljs-keyword">if</span> (valid) {
              <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&#39;success&#39;</span>, dynamicForm);
        ...
        <span class="hljs-function"><span class="hljs-title">remove</span>(<span class="hljs-params"></span>)</span> {
          dynamicForm.state.tels.splice(dynamicForm.state.tels.length - <span class="hljs-number">1</span>, <span class="hljs-number">1</span>);
        },
        <span class="hljs-function"><span class="hljs-title">add</span>(<span class="hljs-params"></span>)</span> {
          <span class="hljs-keyword">let</span> newIndex = dynamicForm.state.tels.length;
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">nut-form-item</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u59D3\u540D&quot;</span> <span class="hljs-attr">prop</span>=<span class="hljs-string">&quot;name&quot;</span> <span class="hljs-attr">required</span> <span class="hljs-attr">:rules</span>=<span class="hljs-string">&quot;[{ required: true, message: &#39;\u8BF7\u586B\u5199\u59D3\u540D&#39; }]&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;nut-input-text&quot;</span> @<span class="hljs-attr">blur</span>=<span class="hljs-string">&quot;customBlurValidate(&#39;name&#39;)&quot;</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;formData.name&quot;</span>
      <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;\u8BF7\u8F93\u5165\u59D3\u540D\uFF0Cblur \u4E8B\u4EF6\u6821\u9A8C&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;text&quot;</span> /&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">nut-form-item</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">nut-form</span>&gt;</span>
    ...
    <span class="hljs-comment">// \u5931\u53BB\u7126\u70B9\u6821\u9A8C</span>
    <span class="hljs-keyword">const</span> customBlurValidate = <span class="hljs-function">(<span class="hljs-params">prop: string</span>) =&gt;</span> {
      ruleForm.value.validate(prop).then(<span class="hljs-function">(<span class="hljs-params">{ valid, errors }: any</span>) =&gt;</span> {
        <span class="hljs-keyword">if</span> (valid) {
          <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&#39;success&#39;</span>, formData);
        } <span class="hljs-keyword">else</span> {
          <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&#39;error submit!!&#39;</span>, errors);
    ...
    <span class="hljs-keyword">return</span> { ruleForm, formData, validate, customValidator, asyncValidator, customBlurValidate, submit, reset };
}
